...
check:
	$(PYTHON) -m py_compile scripts/agent_manager.py scripts/agent_work.py scripts/bluetooth_audio_doctor.py scripts/cento_interactive.py scripts/cluster_job_runner.py scripts/crm_module.py scripts/dashboard_server.py scripts/factory.py scripts/factory_console_e2e.py scripts/factory_dispatch_core.py scripts/factory_dispatch_e2e.py scripts/factory_e2e.py scripts/factory_integration.py scripts/factory_patch.py scripts/factory_plan.py scripts/factory_queue.py scripts/factory_render.py scripts/factory_validate.py scripts/funnel_check.py scripts/funnel_module.py scripts/gather_context.py scripts/idea_board_server.py scripts/industrial_focus.py scripts/industrial_panel.py scripts/industrial_status.py scripts/jobs_server.py scripts/manifest_validate.py scripts/mcp_tooling.py scripts/network_web_server.py scripts/no_model_validate_contract_check.py scripts/no_model_validation_e2e.py scripts/platform_report.py scripts/research_map.py scripts/scan_onepager.py scripts/story_manifest.py scripts/story_screenshot_runner.py scripts/tool_index.py scripts/validation_manifest.py scripts/validator_tier0.py
