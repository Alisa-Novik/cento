...
| `factory` | yes | yes | Manifest-driven factory workflow that turns a high-level request into intake artifacts, queue state, integration gates, Autopilot dry-run control cycles, runtime adapter contracts, and static evidence hubs without default AI dispatch. |
