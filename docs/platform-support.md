...
| `factory` | yes | yes | Plan-only factory workflow that turns a high-level request into intake artifacts, a validated factory-plan.json, story manifests, validation manifests, and static evidence hubs without dispatching AI workers. |
